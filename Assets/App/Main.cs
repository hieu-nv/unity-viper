...
namespace Viper.App
{
  public class Main : MonoBehaviour
  {
    ...
    void Awake()
    {
      ...
      container.Register<IUIViewLocator>(new AddressableUIViewLocator());
    ...
    async void Start()
    {
      ...
      Window1.Window1 window = await locator.LoadWindowAsync<Window1.Window1>(winContainer, "UI/Window1");
      window.Create();
